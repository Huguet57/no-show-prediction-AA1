...
```{r}
# DIR <- 'W://AA1/'
DIR <- 'C://Users/Administrador 2/Desktop/AA1/'
setwd(DIR)
...
# 1.1.2. Neighbourhood encoding

We also might think of encoding the neighbourhoods with shorter, but still recognizable, labels.
